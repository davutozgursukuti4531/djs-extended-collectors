...
const {
  Channel
} = import("discord.js").catch(e => new _VersionError.default(`The package named \`discord.js\` has not been downloaded. to download: npm i discord.js@latest`, {
  type: "UnvalidVersion"
})).then((v) => v);
class ApplicationCommandCollector extends _BaseCollector.default {
...
var _default = ApplicationCommandCollector;
